...
<div class="pagetitle">
      <h1>Upload Resumption</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">School</li>
          <li class="breadcrumb-item active">Resumption</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Upload Resumption</h5>

              <form class="row g-3" method="POST" action="{{ route('resumptions.store') }}">
                @csrf
                <x-alerts />
