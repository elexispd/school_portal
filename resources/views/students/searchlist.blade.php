      ...
      <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <form class="row g-3" method="GET" action="{{ route('students.studentListResult') }}">
                    <!-- First Name -->
                    <div class="col-12">
                        <label for="first_name" class="form-label">Search By Class</label>
                        <select name="class_id" id="class" class="form-control @error('class') is-invalid @enderror" required>
                    ...
                    <div class="col-12">
                        ...
                        <select name="class_arm_id" id="classarm" class="form-control @error('classarm') is-invalid @enderror" required>
